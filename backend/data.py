...
PALABRAS_CLAVE = {
    ...
    "Alimentos y Bebidas": ["restaurante", "mariscos", "comida", "gastronomia",
    ...
    "Servicios de Salud": ["hospital", "clinica", "medico", "salud", "farmacia",
                    "dispensario", "dentista", "emergencia", "doctor", "enfermo"],
    "Transporte": ["taxi", "mototaxi", "movilizarme",
                    "interprovincial", "terminal", "movilidad", "como llegar"],
    "Manifestaciones culturales": ["museo", "patrimonio", "artesania", "arte", "cultura",
    ...
    "Deportes": ["surf", "deporte", "cancha", "estadio", "gimnasio",
    ...
    "Educación": ["universidad", "instituto", "idiomas", "curso", "educacion"],
    "Guianza Turística": ["guia turistico", "guia turistica", "guianza", "tour guiado", "acompañante turistico"],
    "Organizadores de Eventos y Convenciones": ["organizador de eventos", "planificador de bodas", "organizacion de congresos", "convenciones", "organizador de bodas"],
    "Parques Temáticos Y Atracciones Estables": ["parque tematico", "parque de diversiones", "juegos mecanicos", "atracciones"],
    "Sitios Naturales": ["reserva", "ecologico", "cascada", "senderismo", "bosque",
